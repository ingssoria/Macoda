$(document).ready(function() {
    ...
    /*$(window).scroll(function () {
        if($(document).scrollTop() > ($(document).scrollTop()+10)){
            $('div.animatedzoomIn').addClass('animated zoomIn');
        }
    })*/
...
jQuery(document).ready(function() {
    jQuery('.animatedzoomIn').addClass("hidden").viewportChecker({
        classToAdd: 'visible animated zoomIn',
        offset: 100
    });
    jQuery('.animatedbounceIn').addClass("hidden").viewportChecker({
        classToAdd: 'visible animated bounceIn',
        offset: 100
    });
    jQuery('.animatedfadeIn').addClass("hidden").viewportChecker({
        classToAdd: 'visible animated fadeIn',
        offset: 100
    });
    jQuery('.animatedfadeInLeft').addClass("hidden").viewportChecker({
        classToAdd: 'visible animated fadeInLeft',
        offset: 100
    });
    jQuery('.animatedfadeInRight').addClass("hidden").viewportChecker({
        classToAdd: 'visible animated fadeInRight',
        offset: 100
    });
    jQuery('.animatedbounceInLeft').addClass("hidden").viewportChecker({
        classToAdd: 'visible animated bounceInLeft',
        offset: 100
    });
    jQuery('.animatedbounceInRight').addClass("hidden").viewportChecker({
        classToAdd: 'visible animated bounceInRight',
        offset: 100
    });
    jQuery('.animatedtada').addClass("hidden").viewportChecker({
